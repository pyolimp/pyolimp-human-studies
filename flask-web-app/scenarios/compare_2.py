...
<div class="container">
    ...
    <p>Добро пожаловать в эксперимент по изучению восприятия изображений!</p>

    <p>В этом исследовании вам предстоит пройти серию из 30 сравнений пар изображений.<br>
    Каждое изображение в паре показывает одну и ту же сцену, но обработано разными методами.<br>
    В результате вы увидите изображения с разными сочетаниями чёткости, контраста и возможных артефактов.</p>

    <p>Ни одно из изображений не является полностью эталонным — цель эксперимента понять,<br>
    какие варианты обработки воспринимаются людьми как более качественные и комфортные для восприятия.</p>

    <h2>Как проходит эксперимент:</h2>
    <p>На каждом шаге вы увидите два изображения — слева и справа.</p>
    <p>Ваша задача — выбрать то, которое, по вашему мнению, выглядит лучше с визуальной точки зрения:</p>
    <ul>
        <li>более чёткое,</li>
        <li>более естественное,</li>
        <li>менее артефактное,</li>
        <li>или просто более комфортное для восприятия.</li>
    </ul>

    <div class="options">
        <h2>Варианты ответа:</h2>
        <ul>
            <li><strong>Левое изображение</strong> — если левое воспринимается более качественным;</li>
            <li><strong>Правое изображение</strong> — если правое выглядит лучше;</li>
            <li><strong>Затрудняюсь ответить</strong> — если не можете отдать предпочтение ни одному из них.</li>
        </ul>
    </div>
    ...
    <div class="important-note">
        ...
        <ul>
            ...
            <li>Проходить эксперимент следует только на компьютере или ноутбуке — использование телефонов или планшетов запрещено, чтобы избежать искажений восприятия.</li>
        </ul>
    </div>
</div>
"""
