...
<div class="container">
    ...
    <p>
      На экране вам будет показано исходное изображение (в середине)<br>
      и два варианта, как его может увидеть слабовидящий человек. Вам необходимо<br>
      выбрать, какой из вариантов (справа или слева) вы предпочли бы видеть<br>
      вместо исходного (в середине), если бы были слабовидящим.
    </p>

    <p>
      На каждый выбор у вас будет 5 секунд. После того, как они закончатся,<br>
      вам будут предложены варианты ответа: предпочитаете ли вы левое,<br>
      правое или не можете решить, какое предпочесть.<br>
